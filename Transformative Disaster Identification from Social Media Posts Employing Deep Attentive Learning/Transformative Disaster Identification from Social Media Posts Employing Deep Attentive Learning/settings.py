...
ROOT_URLCONF = 'adeep_attentive_multimodal_learning_aApproach.urls'
...
WSGI_APPLICATION = 'adeep_attentive_multimodal_learning_aApproach.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'adeep_attentive_multimodal_learning_aApproach',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
