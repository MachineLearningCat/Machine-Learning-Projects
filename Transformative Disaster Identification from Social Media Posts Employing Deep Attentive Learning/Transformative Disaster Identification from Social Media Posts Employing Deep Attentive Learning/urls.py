"""adeep_attentive_multimodal_learning_aApproach URL Configuration
...
from adeep_attentive_multimodal_learning_aApproach import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Disaster_Tweet_Type/$', remoteuser.Predict_Disaster_Tweet_Type, name="Predict_Disaster_Tweet_Type"),
    ...
    url(r'^View_Disaster_Tweet_Type_Ratio/$', serviceprovider.View_Disaster_Tweet_Type_Ratio, name="View_Disaster_Tweet_Type_Ratio"),

    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Disaster_Tweet_Type/$', serviceprovider.View_Prediction_Of_Disaster_Tweet_Type, name="View_Prediction_Of_Disaster_Tweet_Type"),
