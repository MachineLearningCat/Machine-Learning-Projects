...
--
-- Host: localhost
-- Generation Time: Sep 01, 2022 at 01:09 PM
...
--
-- Database: `adeep_attentive_multimodal_learning_aapproach`
--
CREATE DATABASE IF NOT EXISTS `adeep_attentive_multimodal_learning_aapproach` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `adeep_attentive_multimodal_learning_aapproach`;
...
(1, 'Kumar', 'Kumar123@gmail.com', 'Kumar', '9535866270', 'India', 'Karnataka', 'Bangalore'),
...
(11, 'Naive Bayes', '87.15919085312225'),
(12, 'SVM', '88.56640281442392'),
(13, 'Logistic Regression', '89.44591029023746'),
(14, 'Decision Tree Classifier', '86.63148636763412'),
(15, 'SGD Classifier', '88.96218117854002');
...
--
-- Table structure for table `remote_user_disaster_identification_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_disaster_identification_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idnumber` varchar(300) NOT NULL,
  `keyword` varchar(300) NOT NULL,
  `location` varchar(300) NOT NULL,
  `tweet_text` varchar(30000) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=7 ;

--
-- Dumping data for table `remote_user_disaster_identification_type`
--

INSERT INTO `remote_user_disaster_identification_type` (`id`, `idnumber`, `keyword`, `location`, `tweet_text`, `Prediction`) VALUES
(1, '6', 'ablaze', 'London, England', 'Several houses have been set ablaze in Ngemsibaa village, Oku sub division in the North West Region of Cameroon byâ€¦ https://t.co/99uHGAzxy2\r\n', 'Disaster'),
(2, '9', 'ablaze', 'Searching', 'This creature whoâ€™s soul is no longer clarent but blue ablaze This thing Carrying memories Memories ofâ€¦ https://t.co/tBKSNDrDoX\r\n', 'No Disaster'),
(3, '17', 'ablaze', 'NA', 'Rengoku sets my heart ablazeðŸ˜”â¤ï¸ðŸ”¥ P.s. I missed this style of coloring I do so here it is c: #é¬¼æ»…ã®åˆƒ https://t.co/YrUF9g68s0\r\n', 'No Disaster'),
(4, '22', 'ablaze', 'Italy', '#ThankfulTuesday Isaiah 43:2 When you pass through the waters, I will be with you; and when you pass through the râ€¦ https://t.co/jEp3L1oU36\r\n', 'No Disaster'),
(5, '16', 'NA', 'ablaze', 'No cows today but our local factory is sadly still ablaze #REDJanuary2020 https://t.co/CMyuKzrcKz\r\n', 'Disaster'),
(6, '31', 'ablaze', 'Washington, DC', 'Marivan, Kurdistan Province Monday, Jan 13th, 2020 Protesters set the propaganda banner of #QassemSoleimani ablazeâ€¦ https://t.co/IVGCYJZlmK\r\n', 'Disaster');
